...
1. **Choose an option**: Select 1 to encrypt or 2 to decrypt
2. **Input image path**: Provide the path to your image file
3. **Output image path**: Specify where to save the processed image (include .png or .jpg)
4. **Encryption key**: Enter a numeric key (e.g., 42, 123, etc.)
...
Note: For maximum security, use different images and keys. This method is suitable for casual privacy but not for critical security applications.
📁 Project Structure
```Code
